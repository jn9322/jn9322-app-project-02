...
st.write(
    '''
Description of XML structure/XML Schema with which this application works. There is a download button at the end of this page to download XML Schema in .txt format.
